...
//	public static void readCountryData() throws JsonParseException, JsonMappingException, IOException
//	{
...
//		
//		System.out.println(GetData[0].getCountry().get(0).getStartPoint());
//		System.out.println(GetData[1].getCountry().get(0).getStartPoint());
//		System.out.println(GetData[2].getCountry().get(0).getStartPoint());
