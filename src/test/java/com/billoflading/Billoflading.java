...
public class Billoflading {
    ...
    private Long loadPortRouteSequence;
    ...
    @JsonProperty("loadPortRouteSequence")
    public Long getLoadPortRouteSequence() {
        return loadPortRouteSequence;
    }

    @JsonProperty("loadPortRouteSequence")
    public void setLoadPortRouteSequence(Long loadPortRouteSequence) {
