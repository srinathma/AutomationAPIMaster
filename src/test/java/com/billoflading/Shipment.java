...
public class Shipment {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("shipmentNumber", shipmentNumber).append("shipmentVersionInstance", shipmentVersionInstance).append("receiptCargoMode", receiptCargoMode).append("receiptDeliveryMode", receiptDeliveryMode).append("isDangerous", isDangerous).append("businessUnitCode", businessUnitCode).append("businessEmail", businessEmail).append("parties", parties).append("houseBills", houseBills).append("equipments", equipments).append("cargos", cargos).append("route", route).append("shipmentFreights", shipmentFreights).toString();
    }
