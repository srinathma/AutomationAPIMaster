/*
 * package com.QueueCon; import java.io.PrintWriter;
 * 
 * import com.ibm.mq.MQC; import com.ibm.mq.MQEnvironment; import
 * com.ibm.mq.MQException; import com.ibm.mq.MQGetMessageOptions; import
 * com.ibm.mq.MQMessage; import com.ibm.mq.MQPutMessageOptions; import
 * com.ibm.mq.MQQueue; import com.ibm.mq.MQQueueManager; // Include the MQ
 * package
 * 
 * public class MQCommunicator { private String hostname; // Define the name of
 * your host to connect to // Note. assumes MQ Server is listening on // the
 * default TCP/IP port of 1414 private String qManager; // Define name of queue
 * manager object to connect to.
 * 
