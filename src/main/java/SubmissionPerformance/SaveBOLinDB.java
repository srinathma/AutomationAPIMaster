...
public class SaveBOLinDB {
	...
	public static void main(String[] args) throws IOException {
		...
		// String dbURI = "mongodb://gcdmongodb:6Sbgznu1YXpp7o5YCNCa6VU9R7afLVsfOcrk1OVMhYV7GXOyelDm70bYPfuE64i3SoHPr7pJLvml60LvaT7FSw==@gcdmongodb.documents.azure.com:10255/?ssl=true&replicaSet=globaldb";
			String dbURI="mongodb://gcdmongo-pre-prod:SEntatkatHGDn8SsgdstpPT2Eyd9QzG11PY1588buGlJYWl0tyvLJiCjSjBPvJDeslquqwNQzU8rUpyqhvwRMQ==@gcdmongo-pre-prod.mongo.cosmos.azure.com:10255/?maxIdleTimeMS=120000&ssl=true&authMechanism=SCRAM-SHA-1&authSource=admin";
			MongoClient client = new MongoClient(new MongoClientURI(dbURI));
		 
		   for(int i=40000;i<40050;i++)
			{
		 String jsonString = FileUtils.readFileToString(new File("C:\\Srinath\\SPT\\SubmissionData\\SRIL"+i+".json"), "UTF-8");
